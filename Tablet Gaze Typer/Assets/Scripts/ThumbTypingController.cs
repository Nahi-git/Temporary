...
public class ThumbTypingController : MonoBehaviour
{
    ...
    public string GetCenterKeyLabel()
    {
        ...
        if (centerKeyButton.gameObject != null)
        {
            ...
            if (buttonName.Contains("space"))
                return " ";
            if (buttonName.Contains("backspace"))
                return "";
        }
        ...
        if (string.IsNullOrEmpty(text))
        {
            if (originalButtonTexts.ContainsKey(centerKeyButton))
            {
                ...
                if (originalText == " " || (string.IsNullOrWhiteSpace(originalText) && centerKeyButton.gameObject != null && centerKeyButton.gameObject.name.ToLower().Contains("space")))
                    return " ";
            }
            return "";
        }
    ...
    public string GetSelectedKeyLabel()
    {
        ...
        if (string.IsNullOrEmpty(text))
        {
            if (originalButtonTexts.ContainsKey(selectedKey))
            {
                ...
                if (originalText == " " || (string.IsNullOrWhiteSpace(originalText) && selectedKey.gameObject != null && selectedKey.gameObject.name.ToLower().Contains("space")))
                    return " ";
            }
            return "";
        }
    ...
    public bool IsThreeByThreeDisplayed()
    {
        return surroundingKeysPanel != null && surroundingKeysPanel.activeSelf;
    }
    
    public bool IsCharacterInThreeByThree(string character)
    {
        ...
        foreach (var kvp in keyObjectToButtonMap)
        {
            ...
            if (button.gameObject != null)
            {
                ...
                if (buttonName.Contains("space") && isSpace)
                    return true;
                if (buttonName.Contains("backspace") && normalizedChar == "")
                    return true;
            }
